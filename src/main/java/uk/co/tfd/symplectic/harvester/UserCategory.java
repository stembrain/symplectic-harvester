...
public class UserCategory implements Category, RecordStreamOrigin   {

	
	private static final Logger LOGGER = LoggerFactory.getLogger(UserCategory.class);
	...
	public UserCategory(RecordHandler rh) {
		this.rh = rh;
	}
	@Override
