...
public class XmlAide {
	public static Document loadXmlDocument(String url) throws MalformedURLException, SAXException, IOException, ParserConfigurationException {
	...
	public static String findAttribute(Node n,
	...
	public static String getXmlFromNode(Node node) throws TransformerFactoryConfigurationError, TransformerException {
